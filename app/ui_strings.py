...
UI_TEXTS: Dict[str, str] = {
    ...
    "analytics_degraded_mode": "Mostrando dados recentes, atualizando em segundo plano.",
...
MESSAGES: Dict[str, Dict[str, str]] = {
    "success": {
        ...
        "erp_send_queued": "Envio ao ERP registrado. Vamos processar e atualizar o status automaticamente.",
    ...
    "error": {
        ...
        "csrf_invalid": "Sessao de formulario expirada. Atualize a pagina e tente novamente.",
        ...
        "rate_limit_exceeded": "Muitas requisicoes em pouco tempo. Aguarde alguns segundos e tente novamente.",
        ...
        "analytics_rate_limited": "Recebemos muitas consultas agora. Tente novamente em instantes.",
